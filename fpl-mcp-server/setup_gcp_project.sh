...
PROJECT_ID="fpl-adk-mcp" # Your Google Cloud Project ID
REGION="us-central1"     # Your desired region
REPO_NAME="fpl-mcp-repo" # Your Artifact Registry repository name

# This is the Cloud Build service account used during the build process.
# Confirmed from your logs: '588879186701-compute@developer.gserviceaccount.com'.
CLOUD_BUILD_SA_EMAIL="588879186701-compute@developer.gserviceaccount.com"

# This is the dedicated service account for the Cloud Run service itself.
SERVICE_ACCOUNT_NAME="fpl-mcp-run-sa"
SERVICE_ACCOUNT_FULL_EMAIL="${SERVICE_ACCOUNT_NAME}@${PROJECT_ID}.iam.gserviceaccount.com"

# This is your personal user account that performs the deployment.
# Gcloud uses this account to authenticate when running 'gcloud run deploy'.
DEPLOYING_USER_EMAIL="anshul@anshulkapoor.altostrat.com" # <--- IMPORTANT: Update with your actual gcloud authenticated user email
